...
export const DUMMY_ARTICLES: Article[] = [
  {
    ...
    Regular physical activity also plays a significant role in mental health. Exercise releases endorphins, which are natural mood boosters that can help reduce stress and anxiety levels.

    Building strong social connections is another vital component. Having a support system of friends, family, or community members provides emotional stability and helps us navigate life's challenges more effectively.
  ...
  },
  {
    ...
    Cognitive-behavioral techniques can be particularly helpful in managing anxiety. These include identifying negative thought patterns, challenging irrational beliefs, and developing more balanced perspectives.

    Breathing exercises and progressive muscle relaxation are practical tools that can provide immediate relief during anxious moments. These techniques help activate the body's relaxation response.
  ...
  },
  {
    ...
    Strong relationships and social support networks are crucial components of resilience. Having people you can turn to during difficult times provides emotional comfort and practical assistance.

    Self-care practices play a vital role in maintaining resilience. This includes getting adequate sleep, eating nutritious foods, exercising regularly, and engaging in activities that bring joy and relaxation.

    Learning to regulate emotions through mindfulness and stress management techniques helps build the emotional stability needed to weather life's storms.
  ...
  },
  {
    ...
    Emotional self-care involves acknowledging and processing your feelings, setting healthy boundaries, practicing self-compassion, and engaging in activities that bring you joy.

    Mental self-care includes activities that stimulate your mind in positive ways, such as reading, learning new skills, practicing mindfulness, and engaging in creative pursuits.

    Social self-care involves nurturing relationships that make you feel supported and valued while also setting boundaries with people who drain your energy.

    Spiritual self-care doesn't necessarily involve religion but rather activities that help you feel connected to something larger than yourself, such as spending time in nature or practicing gratitude.
  ...
  },
  {
    ...
    Expressing emotions clearly and constructively is crucial. Using "I" statements instead of "you" statements helps avoid blame and creates a safer space for honest communication.

    Conflict is normal in relationships, but how we handle it makes all the difference. Focus on the specific issue at hand rather than bringing up past grievances, and work together toward solutions.

    Setting and respecting boundaries is essential for healthy relationships. This includes being clear about your needs, limits, and expectations while also respecting those of others.

    Regular check-ins with your partner, friends, or family members can help address small issues before they become major problems. Make time for meaningful conversations about how the relationship is going.
  ...
  },
  {
    ...
    Time management skills are crucial for balance. Prioritize tasks based on importance and urgency, use calendar blocking to protect personal time, and avoid multitasking, which can decrease productivity.

    Technology can be both a help and a hindrance. While it enables flexibility, it also makes us constantly available. Set specific times for checking emails and messages, and consider turning off work notifications during personal time.

    Regular breaks throughout the workday are essential for maintaining productivity and preventing burnout. Take short walks, practice deep breathing, or simply step away from your workspace.

    Make personal time non-negotiable. Schedule activities you enjoy just as you would schedule work meetings, and protect this time from work intrusions.
