    ...
    <form onSubmit={handleSubmit} className="bg-white p-6 space-y-6">
      ...
      <div className="flex items-center  gap-4">
        ...
        <input
          ...
          className="flex-1 max-w-md bg-gray-100 border border-gray-300 px-3 py-2 rounded-md file:mr-4 file:py-2 file:px-4 file:border-0 file:text-sm file:bg-Dblue file:text-white"
        />
      </div>
