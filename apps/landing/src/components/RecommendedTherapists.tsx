...
const RecommendedTherapists: React.FC = () => {
    return (
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Meet Our Therapists</h2>
        </div>
  
        <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6">
          {therapists.map(({ id, name, specialty, reviews, stars, experience, rate, image }) => (
            <div
              key={id}
            ...
            >
              ...
              <div className="p-3 flex-1">
                ...
                <p className="text-xs text-gray-600 mb-1">Experience: {experience} years</p>
                <p className="text-xs text-gray-600 mb-2">Rate: {rate}</p>
                <div className="flex items-center gap-3 mt-2">
                  <button className="bg-Dblue text-white text-xs px-3 py-1.5 rounded hover:bg-blue-700 transition-all">
                    Book Now
                  </button>
                  <FaUserCircle
